...
import { Lifts, UserStats } from '../types';

interface OnboardingProps {
  onComplete: (lifts: Lifts) => void;
}
  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-gray-400">Bevor die Journey beginnt, müssen wir wissen, wo du stehst. Dein Einhorn passt sich deiner Kraft an.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="glass p-8 rounded-[2rem] space-y-6">
        ...
        <button 
          type="submit"
          className="w-full py-5 unicorn-gradient rounded-2xl font-bold text-xl uppercase tracking-widest shadow-xl shadow-purple-500/10"
        >
          Journey Starten
        </button>
      </form>
